...
io.on('connection', (socket) => {
    ...
    socket.on('disconnect', () => {
        ...
        io.emit('update', {id: socket.id, name: users[socket.id], msg: `User ${users[socket.id]} has disconnected`, status: 'disconnected'});
